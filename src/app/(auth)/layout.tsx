...
export default function AuthLayout({
  ...
  return (
    <div className="flex justify-center items-start sm:items-center h-screen">
      <div className=" sm:border-2 sm:shadow-md sm:rounded-lg flex flex-col p-10 justify-start pt-14 sm:justify-center space-y-8 sm:space-y-14 items-center " >
        <h1 className="text-center text-3xl font-bold">Sign In To BulletinX</h1>
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-5 sm:space-x-10 ">
